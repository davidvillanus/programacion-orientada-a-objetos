...
//metodos
	...
	public void AtravezarIntercepcion(Calle calle, long timeStamp) {
		if (color=="verde"){
			System.out.println("El semaforo" + this.orientation +
				...
				" Carros comienzan a cruzar " + calle.getOrientacion() + 
			...
			System.out.println("El semaforo" + this.orientation + 
			"Esta en color"+ this.color+
			" Carros estan parados " + calle.getOrientacion() + 
			" EN EL TIEMPO: " + (System.currentTimeMillis() - timeStamp) / 1000	+
			"seg");
			for (int i = 0; i <=5; i++) { 
				this.esperarXsegundos(calle.getCarros()[i]); 
	...
	System.out.println("LOS SEMAFOROS HAN CAMBIADO DE COLOR EN EL TIEMPO: " + 
